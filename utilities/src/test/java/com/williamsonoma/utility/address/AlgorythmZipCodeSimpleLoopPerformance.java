 ...
 * Date: 7/7/2018
 *
 * Test performance of simple loop iteration with different sample sizes.
 */
@RunWith(SpringRunner.class)
@ContextConfiguration
@SpringBootTest
public class AlgorythmZipCodeSimpleLoopPerformance
{
    @Configuration
    static class Config
    {
        ...
        public ZipCode zipCode() {
            return new AlgorythmZipCode(false);
        }
    }
    ...
    private static final Logger logger = LogManager.getLogger(AlgorythmZipCodeSimpleLoopPerformance.class);

    @Test
    public void compactOneThousandInParallel()
    {
        logger.info("Begin simple loop performance test for one thousand ranges");
    ...
    {
        logger.info("Begin simple loop performance test for ten thousand ranges");
    ...
    {
        logger.info("Begin simple loop performance test for one hundred thousand ranges");
    ...
    {
        logger.info("Begin simple loop performance test for one million ranges");
    ...
    {
        logger.info("Begin simple loop performance test for five million ranges");
